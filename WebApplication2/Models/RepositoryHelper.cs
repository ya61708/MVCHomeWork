namespace WebApplication2.Models
{
	public static class RepositoryHelper
	{
		...
		public static 數量ViewRepository Get數量ViewRepository()
		{
			var repository = new 數量ViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 數量ViewRepository Get數量ViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new 數量ViewRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
